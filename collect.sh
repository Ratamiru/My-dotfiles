...
copy_config "$HOME_DIR/.config/waybar"    ".config/waybar"
copy_config "$HOME_DIR/.config/fuzzel"    ".config/fuzzel"
copy_config "$HOME_DIR/.config/mako"      ".config/mako"
...
copy_config "$HOME_DIR/.config/wlogout"   ".config/wlogout"
copy_config "$HOME_DIR/.config/eww"       ".config/eww"
copy_config "$HOME_DIR/.config/ags"       ".config/ags"
copy_config "$HOME_DIR/.config/quickshell" ".config/quickshell"
copy_config "$HOME_DIR/.config/hypr"      ".config/hypr"
copy_config "$HOME_DIR/.config/matugen"   ".config/matugen"
